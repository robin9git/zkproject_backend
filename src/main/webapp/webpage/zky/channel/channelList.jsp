...
<t:datagrid name="channelList" title="common.operation" actionUrl="channelController.do?datagrid" 
	...
	<t:dgToolBar title="common.add.param" langArg="common.channel" icon="icon-add" url="channelController.do?addorupdate" funname="add"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.channel" icon="icon-edit" url="channelController.do?addorupdate" funname="update"></t:dgToolBar>

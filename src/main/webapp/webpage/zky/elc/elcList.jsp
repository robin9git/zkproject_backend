...
<t:datagrid name="fList" title="文件下载" actionUrl="elcController.do?datagrid" idField="id" fit="true" sortName="creatDate" sortOrder="desc">
...
<%-- 	<t:dgOpenOpt width="800" height="700" url="elcController.do?openViewFile&fileid={id}&subclassname={subclassname}" title="预览"></t:dgOpenOpt> --%>
	<t:dgDelOpt url="elcController.do?del&id={id}" title="删除"></t:dgDelOpt>
	<t:dgToolBar title="附件录入" icon="icon-add" funname="add" url="elcController.do?addFiles" height="600"></t:dgToolBar>
	<t:dgToolBar title="附件编辑" icon="icon-add" funname="update" url="elcController.do?addFiles" height="600"></t:dgToolBar>
</t:datagrid>
...
<script type="text/javascript">
	...
	$(function() {
		$('#cc').combotree({
			url : 'menuController.do?setPFunction&selfId=${function.id}',
			panelHeight: 200,
			width: 157,
...
<t:formvalid formid="formobj" layout="div" dialog="true" refresh="true" action="menuController.do?saveFunction">

...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="compController.do?save" >
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" width="85%">
                <input id="addr" class="inputxt" name="addr" value="${ent.addr }" datatype="*" maxlength="40">

...
<t:datagrid name="recruitList" title="common.operation" actionUrl="zkyenrecruitController.do?datagrid" 
...
<%-- 	<t:dgCol title="common.status" sortable="true" field="status" replace="common.active_1,common.inactive_0,super.admin_-1" ></t:dgCol> --%>
	...
	<t:dgDelOpt title="common.delete" url="zkyenrecruitController.do?del&id={id}" />
	<t:dgToolBar title="common.add.param" langArg="common.recruit" icon="icon-add" url="zkyenrecruitController.do?addorupdate" funname="add" width="900" height="850"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.recruit" icon="icon-edit" url="zkyenrecruitController.do?addorupdate" funname="update" width="900" height="850"></t:dgToolBar>

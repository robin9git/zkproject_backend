...
<t:datagrid name="channelList" title="common.operation" actionUrl="zkyenchannelController.do?datagrid" 
	...
	<t:dgCol title="common.department" sortable="false" field="userOrgList.tsDepart.departname" ></t:dgCol>
    <%--update-end--Author:zhangguoming  Date:20140827 for：通过用户对象的关联属性值获取组织机构名称（多对多关联）--%>
	<t:dgCol title="common.real.name" field="realName"></t:dgCol>
	...
	<t:dgToolBar title="common.add.param" langArg="common.channel" icon="icon-add" url="zkyenchannelController.do?addorupdate" funname="add"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.channel" icon="icon-edit" url="zkyenchannelController.do?addorupdate" funname="update"></t:dgToolBar>

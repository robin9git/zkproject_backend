...
<t:datagrid name="compList" title="common.operation" actionUrl="zkyencompController.do?datagrid" 
...
<%-- 	<t:dgToolBar title="common.add.param"  langArg="comp.info" icon="icon-add" url="compController.do?addorupdate" funname="add" width="900" height="550"></t:dgToolBar> --%>
	<t:dgToolBar title="common.edit.param" langArg="comp.info" icon="icon-edit" url="zkyencompController.do?addorupdate" funname="update" width="900" height="550"></t:dgToolBar>
</t:datagrid>
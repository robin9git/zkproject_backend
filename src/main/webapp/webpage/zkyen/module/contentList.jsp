...
<t:datagrid name="moduleList" title="common.operation" actionUrl="zkyenmoduleController.do?datagrid" 
...
<%-- 	<t:dgCol title="common.status" sortable="true" field="status" replace="common.approvalPass_1,common.approvalWait_0,common.approvalFail_2" ></t:dgCol> --%>
	...
	<t:dgDelOpt title="common.delete" url="zkyenmoduleController.do?del&id={id}" />
	<!-- 	图片编辑 -->
...
<%-- 	</c:if> --%>
	...
	<t:dgToolBar title="common.add.param" langArg="common.content" icon="icon-add" url="zkyenmoduleController.do?addorupdate" funname="add" width="900" height="650"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.content" icon="icon-edit" url="zkyenmoduleController.do?addorupdate" funname="update" width="900" height="650"></t:dgToolBar>
</t:datagrid>
...
//    var windowapi = frameElement.api, W = windowapi.opener;
	...
	function review(id) {
		var url="zkyenmoduleController.do?changeStatus&id="+id;
		//异步修正内容的审核状态
		changeStatus(url);
	}

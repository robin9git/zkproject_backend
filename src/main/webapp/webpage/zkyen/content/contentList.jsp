...
<!-- sortName="creatTime" -->
<t:datagrid name="contentList" title="common.operation" actionUrl="zkyencontentController.do?datagrid" 
...
<%-- 	</c:if> --%>
	...
	<t:dgDelOpt title="common.delete" url="zkyencontentController.do?del&id={id}" />
	<t:dgToolBar title="common.add.param" langArg="common.content" icon="icon-add" url="zkyencontentController.do?addorupdate" funname="add" width="900" height="800"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.content" icon="icon-edit" url="zkyencontentController.do?addorupdate" funname="update" width="900" height="800"></t:dgToolBar>
</t:datagrid>
...
//    var windowapi = frameElement.api, W = windowapi.opener;
	...
	function review(id) {
		var url="zkyencontentController.do?changeStatus&id="+id;
		//异步修正内容的审核状态
		changeStatus(url);
	}

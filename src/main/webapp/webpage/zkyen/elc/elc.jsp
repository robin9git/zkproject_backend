...
<t:formvalid formid="formobj" layout="div" dialog="true" action="zkyenelcController.do?saveContent" >
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" width="85%">
	        	<t:dictSelect field="year" typeGroupCode="zkyYear" hasLabel="false" defaultVal="${ent.year!=null?ent.year:2015}" ></t:dictSelect>
	        </td>
		</tr>
		<tr>
			<td align="right" width="15%" nowrap><label class="Validform_label">标题1: </label></td>
			<td class="value" width="85%">
	        	<input type="text" name="title1" value="${ent.title1 }" datatype="*" >
	        </td>
		</tr>
		<tr>
			<td align="right" width="15%" nowrap><label class="Validform_label">标题2: </label></td>
			<td class="value" width="85%">
	        	<input type="text" name="title2" value="${ent.title2 }" datatype="*" >
	        </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="value" width="85%">
	        	<t:ckfinder name="fileSrc" size="fileSize" uploadType="Files" value="${ent.picSrc}" width="100" height="60" buttonClass="ui-button" buttonValue="上传附件"></t:ckfinder>
	        </td>
		</tr>
		<tr>

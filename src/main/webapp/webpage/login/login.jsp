            ...
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div>
                        ...
                        <input class="randCode" name="randCode" type="text" id="randCode" title="" nullmsg="" />
                    </div>
...
<%--                             <t:dictSelect id="langCode" field="langCode"  typeGroupCode="lang" hasLabel="false" defaultVal="zh-cn"></t:dictSelect> --%>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; <t:mutiLang langKey="common.copyright"/> <span class="tip"><a href="#" title=<t:mutiLang langKey="common.platform"/>>RGI</a> <t:mutiLang langKey="common.browser.recommend"/></span></div>
    </div>
    <!-- Link JScript-->

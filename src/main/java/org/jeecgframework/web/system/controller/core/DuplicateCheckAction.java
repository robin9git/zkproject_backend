...
public class DuplicateCheckAction extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(params = "doDuplicateCheck2")
	@ResponseBody
	public AjaxJson doDuplicateCheck2(DuplicateCheckPage duplicateCheckPage, HttpServletRequest request) {
		...
		String sql = "SELECT count(*) FROM t_s_document WHERE year="+"? and documenttitle="+"?";
		num = jdbcDao.getCountForJdbcParam(sql, new Object[]{request.getParameter("year"),request.getParameter("documentTitle")});
